...
const ELEMENT_DATA: PeriodicElement[] = [
  {name: 'Mail', url: 'cemugrs@gmail.com', icon: 'https://proino.com/wp-content/uploads/2018/10/Mail-icon.png'},
  ...
  {name: 'Spotify', url: 'open.spotify.com/user/cemugrs', icon: '/assets/sidebar/spotify-icon.png'},
